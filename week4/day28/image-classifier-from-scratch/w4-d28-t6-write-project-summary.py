...
metrics_path = OUTPUT/"metrics.json"; history = json.loads(metrics_path.read_text()) if metrics_path.exists() else []
...
"""
OUTPUT.mkdir(exist_ok=True); path=OUTPUT/"project-summary.md"; path.write_text(summary); print(summary); print("Saved:", path)
