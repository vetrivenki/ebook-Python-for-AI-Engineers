...
models = {
    ...
    "XGBoost": XGBClassifier(n_estimators=80, max_depth=3, learning_rate=0.08, subsample=0.9, colsample_bytree=0.9, eval_metric="logloss", tree_method="hist", random_state=42, n_jobs=1),
}
scores = {}
...
print("XGBoost minus Random Forest:", round(scores["XGBoost"] - scores["Random Forest"], 3))
