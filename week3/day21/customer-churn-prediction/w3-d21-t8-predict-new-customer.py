...
from churn_common import (
    fit_solution, save_solution, validate_features, parse_options, OUTPUT,
)
...
customer = pd.DataFrame([{
    "tenure_months": 12, "monthly_charge": 80.0, "support_calls": 3,
    "contract": "monthly", "payment_method": "card",
}])
